...
class LoginMessages with ChangeNotifier {
  LoginMessages({
    ...
    this.firstName: defaultFirstNameField,
    this.lastName: defaultLastNameField,
    this.phoneNumber: defaultPhoneNumberFiled,
  ...
  static const defaultFirstNameField = 'First Name';
  static const defaultLastNameField = 'Last Name';
  static const defaultPhoneNumberFiled = 'Phone Number';
