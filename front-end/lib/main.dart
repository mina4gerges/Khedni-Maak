    ...
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        ...
        '/auth/DashboardScreen/navBar/mapScreen': (BuildContext context) {
         return MapScreen(apiKey: Secrets.API_KEY, initialPosition: LatLng(0, 0));
        },
        '/auth/DashboardScreen/navBar/driverRidesScreen': (BuildContext context) {
          return RidesScreen(source:'driver');
        },
        '/auth/DashboardScreen/navBar/riderRidesScreen': (BuildContext context) {
